            ...
            <div className="page-wrapper">
                <div className="content">
                    ...
                    <FullSection type={types.web}>
                        <ProjectView type={types.web} width={this.width}>
                            <CenteredText type={types.web}>
                                ...
                                <div>
                                    ...
                                    <p>Programmering var en riktning som jag hamnade mer och mer i under
                                        universitetsperioden och
                                        verkligen
                                        började tycka om.</p>
                                    <p>Att hitta lösningar och kunna interagera med kod visuellt i klienten känns rätt
                                        magiskt.</p>
                                </div>
                            </CenteredText>
                        </ProjectView>
                    ...
                    <FullSection type={types.game}>
                        <ProjectView type={types.game} width={this.width}>
                            <CenteredText type={types.game}>
                                ...
                                <div>
                                    ...
                                    <p>Det handlar mindre om själva spelandet, utan mer om att komma på intressanta
                                        spelmekaniker,
                    ...
                    <FullSection type={types.music}>
                        <ProjectView type={types.music} width={100}>
                            <CenteredText type={types.music}>
                                <div>
                                    <h3>Musik</h3>
                                </div>
                                <div>
                                    <p>Fastnade för folkmusik och började spela piano, dragspel och sedan gitarr under
                                        gymnasiet har ett
                                        generellt intresse av att skapa saker. Musik är fantastiskt och något jag
                                        konsumerar i stora
                                        mängder. Har fortfarande drömmar om att spela i litet band, uppträda och allt
                                        vad det innebär.</p>
                                    <p>Har långlivade planer på att spela in ett eget album åtminstonde, men det har
                                        inte riktigt blivit
